...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
        return item;
    }
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
