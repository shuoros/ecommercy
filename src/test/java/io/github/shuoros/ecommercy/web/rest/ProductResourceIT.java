...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).brand(DEFAULT_BRAND).rate(DEFAULT_RATE).description(DEFAULT_DESCRIPTION);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).brand(UPDATED_BRAND).rate(UPDATED_RATE).description(UPDATED_DESCRIPTION);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).brand(UPDATED_BRAND).rate(UPDATED_RATE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).brand(UPDATED_BRAND).rate(UPDATED_RATE).description(UPDATED_DESCRIPTION);
