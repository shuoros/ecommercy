...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().score(DEFAULT_SCORE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().score(UPDATED_SCORE);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getScore()).isEqualTo(DEFAULT_SCORE);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.score(UPDATED_SCORE);
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getScore()).isEqualTo(UPDATED_SCORE);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.score(UPDATED_SCORE);
